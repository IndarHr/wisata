...
<html lang="id">
  <head>
    ...
    <meta name="description" content="Source Code Sistem Informasi Geografis / Geographic Information System (GIS) berbasis web dengan PHP dan MySQL. Studi kasus: lokasi."/>
  ...
  <body>
    <nav class="navbar navbar-default navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="?">DAERAH WISATA</a>
        </div>
    ...
    <footer class="footer bg-primary">
      <div class="container">
        <p>Copyright &copy; <?=date('Y')?> INDAR HR <em class="pull-right">indar3644@gmail.com</em></p>
      </div>
    </footer>
</body>
</html>